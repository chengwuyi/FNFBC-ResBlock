...
submit_file = sys.argv[1]  # D:/task1/end_to_end/end_to_end_new/PA/Baseline-RawNet2/scores_20bands_PA.txt
truth_dir = sys.argv[2]  # ./keys
phase = sys.argv[3]  # eval

asv_scr_file = os.path.join(truth_dir, 'ASVspoof2019.PA.asv.eval.gi.trl.scores.txt')
asv_key_file = 'D:/task1/ASVspoof2019/PA/ASVspoof2019_PA_asv_protocols/ASVspoof2019.PA.asv.eval.gi.trl.txt'
...
def load_asv_metrics():
    ...
    tar_asv = asv_scr_data[asv_scr_data[1] == 'target'][2]
    non_asv = asv_scr_data[asv_scr_data[1] == 'nontarget'][2]
    spoof_asv = asv_scr_data[asv_scr_data[1] == 'spoof'][2]
...
def performance(cm_scores, Pfa_asv, Pmiss_asv, Pfa_spoof_asv, invert=False):
    ...
    spoof_cm = cm_scores[cm_scores[3] != 'bonafide']['1_x'].values
    # print(cm_scores)
    # print(bona_cm)
    # print(spoof_cm)
    if invert == False:
...
if __name__ == "__main__":
    ...
    _ = eval_to_score_file(submit_file, asv_key_file)
